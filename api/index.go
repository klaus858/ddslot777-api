...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	case "/api/admin/summary":
		requireToken(w, r, summaryHandler)
	case "/api/admin/members":
		requireToken(w, r, membersHandler)
	case "/api/admin/deposits":
		requireToken(w, r, depositsHandler)
	case "/api/admin/deposits/confirm":
		requireToken(w, r, confirmDepositHandler)
	default:
...
func requireToken(w http.ResponseWriter, r *http.Request, next http.HandlerFunc) {
